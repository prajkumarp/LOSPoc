...
class PrimaryFont{
    ...
    init(){
        if((UIFont(name: Constants.primaryBold   , size: 16)) != nil){
            bold    = UIFont(name: Constants.primaryBold   , size: 16)!
        }else{
            bold = systemFont
        }
        
        medium  = UIFont(name: Constants.primaryMedium , size: 16) ?? systemFont
        regular = UIFont(name: Constants.primaryRegular, size: 16) ?? systemFont
    }
}
...
class SecondaryFont{
    ...
    init(){
        bold    = UIFont(name: Constants.secondaryBold   , size: 16) ?? systemFont
        medium  = UIFont(name: Constants.secondaryMedium , size: 16) ?? systemFont
        regular = UIFont(name: Constants.secondaryRegular, size: 16) ?? systemFont
    }
}
...
class TropilineFont{
    ...
    init(){
        bold    = UIFont(name: Constants.tropilineBold   , size: 16) ?? systemFont
        regular = UIFont(name: Constants.tropilineRegular, size: 16) ?? systemFont
    }
